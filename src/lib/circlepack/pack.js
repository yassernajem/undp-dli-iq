// adapted form https://observablehq.com/@mbostock/packing-circles-inside-a-rectangle
export default function pack(circles, width, height) {
  ...
  function score(node, width, height) {
    const a = node._;
    const b = node.next._;
    const ab = a.r + b.r;
